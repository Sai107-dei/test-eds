...
function disableButton() {
  const button = document.querySelector('.ntVziG_spectrum-ActionButton.ntVziG_spectrum-BaseButton.ntVziG_i18nFontFamily.ntVziG_spectrum-FocusRing.ntVziG_spectrum-FocusRing-ring.ntVziG_spectrum-ActionButton--quiet');
  if (button) {
